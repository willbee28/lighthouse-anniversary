const Sponsors = () => {
  return (
    <>
      ...
      <div className="flex items-center text-4xl font-bold mt-24 mb-12 text-center leading-12">
        <hr className="border-1 w-30 mx-2 border-slate-600 " />
      ...
      <div className="flex flex-row flex-wrap justify-center gap-12 mt-1">
        ...
        <div className="w-44 h-44 flex justify-center items-center">
          ...
          >
            <img
              src="/sponsor-logos/dean_refined.webp"
              alt="Dean Yacht Company"
            />
          </a>
        </div>
        <div className="w-44 h-44 flex justify-center items-center">
          ...
          >
            <img
              src="/sponsor-logos/bachman.png"
              alt="Bachman roofing solutions"
            />
          </a>
        </div>
        <div className="w-44 h-44 flex justify-center items-center">
        ...
        <div className="w-44 h-44 flex justify-center items-center">
          ...
          >
            <img
              src="/sponsor-logos/fishtalk_refined.png"
              alt="fish talk magazine"
            />
          </a>
        </div>
